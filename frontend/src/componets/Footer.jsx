        ...
        <div className='bg-gray-900 text-white py-10 px-4 '>
            <div className='px-7 h-32" flex justify-between items-center'>
                 <div className='md:w-1/2 w-full'>
                   ...
                   <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Subscribe</button>
                </div>
             </form>
            </div >
                <div className=' '>
